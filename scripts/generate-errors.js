...
let shell = '# Generated by scripts/generate-errors.js; do not edit.\nteamcodex_error() {\n  case "$1" in\n';
...
shell += '    *) return 2 ;;\n  esac\n}\n';
const python = `# Generated by scripts/generate-errors.js; do not edit.\nMESSAGES = {\n${
...
for (const [path, content] of [['scripts/errors.sh', shell], ['scripts/errors.py', python], ['docs/errors.md', docs]]) {
  if (check) {
    if (await readFile(path, 'utf8') !== content) {
      console.error(`${path} is stale; run npm run errors:generate`);
      process.exitCode = 1;
    }
