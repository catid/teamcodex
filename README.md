...
7. SSE streams track usage, including CRLF events and `data:` fields without a space. An embedded 429 can retry another account before any output is sent; after output starts, a retryable failure event and a clean HTTP close let Codex recover.
